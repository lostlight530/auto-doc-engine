...
Artifact lineage may travel with artifact-record references into the downstream evidence stack, but the downstream repositories do not inherit scientific validity or reproduction status
...
Current design is informed by work such as Praxist on solution/evidence lineage and ReproAgent on persistent contracts across long research trajectories

The borrowed principle is narrow: inheritance and constraints should be explicit and inspectable
...
The August research-infrastructure stage is closed as of 2026-08-31. Stage closure does not rewrite predecessor artifacts or upgrade lineage into scientific authority
