...
Root is reserved for repository/platform entry points and machine entry points that materially benefit from root placement: README files, `MANIFEST.yaml`, `AGENTS.md`, contributor/citation/license metadata, `Makefile`, and implementation directories.
...
Superseded Superpowers design/planning records remain archived under `docs/03-maintenance-and-audit/history/superpowers/`; their content remains historical evidence.
